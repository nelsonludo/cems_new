...
Partial Class userAddPanel
    ...
    Private Sub InitializeComponent()
        ...
        Me.Panel1.Controls.Add(Me.addUserErrorMsg)
        Me.Panel1.Controls.Add(Me.userUserAddTitleInput)
        Me.Panel1.Controls.Add(Me.userUserAddConfirmPwdInput)
        Me.Panel1.Controls.Add(Me.Label6)
        Me.Panel1.Controls.Add(Me.userUserAddPwdInput)
        Me.Panel1.Controls.Add(Me.Label14)
        Me.Panel1.Controls.Add(Me.Label15)
        Me.Panel1.Controls.Add(Me.userUserAddPhoneInput)
        Me.Panel1.Controls.Add(Me.Label16)
        Me.Panel1.Controls.Add(Me.userUserAddEmailInput)
        Me.Panel1.Controls.Add(Me.Label17)
        Me.Panel1.Controls.Add(Me.userAddCancelBtn)
        Me.Panel1.Controls.Add(Me.userUserAddNameInput)
        Me.Panel1.Controls.Add(Me.userAddvalidationBtn)
