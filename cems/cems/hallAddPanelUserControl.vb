...
Public Class hallAddPanelUserControl
    ...
    Private Sub HallAddCancelBtn_Click(sender As Object, e As EventArgs) Handles HallAddCancelBtn.Click 'cancel add
        ...
        hallAddPanelUserControl.hallAddpanel.Visible = False
    End Sub
    ...
    Private Sub HallAddValidateBtn_Click(sender As Object, e As EventArgs) Handles HallAddValidateBtn.Click 'validate add
        ...
        If hallAddPanelUserControl.adminAddHallNameInput.Text = "" Then
            hallAddPanelUserControl.addHallErrorMsg.Text = "please fill the field !"
            hallAddPanelUserControl.addHallErrorMsg.Visible = True
        ...
        Else
            Try
                sqlConn.Open()
                sqlQuery = "insert into cems.cems_halls(hall_name) values ('" & hallAddPanelUserControl.adminAddHallNameInput.Text & "')"
